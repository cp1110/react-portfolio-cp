...
export const PROJECTS = [
  ...
  },
  {
    ...
    technologies: ["HTML", "CSS", "React", "TailwindCSS", "Javascript"],
  },
  {
    title: "Musify",
    image: project4,
    description:
      "Developed Musify, a dynamic frontend application built with Javascript, HTML, CSS, offering users a seamless music streaming experience. Focused on responsive design and intuitive user interaction.",
    technologies: ["HTML", "CSS", "Javascript"],
  },
];

export const CONTACT = {
  address: "Q 14 Sector 12 Noida Uttar Pradesh 201301 ",
  phoneNo: "+918077490353 ",
  email: "chandra.pra3047@gmail.com",
};
